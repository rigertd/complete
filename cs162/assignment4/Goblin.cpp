...
/*************************************************************************
 *  Function:       void Goblin::regenerate()
 *  Description:    Regenerates a random percentage of lost strength points.
 *                  Resets achillesEnabled flag.
 *  Parameters:     none
 *  Preconditions:  none
 *  Postconditions: achillesEnabled is false
 ************************************************************************/
void Goblin::regenerate()
{
    achillesEnabled = false;
