...
int DFS(Graph* g, Vertex* source, Vertex* destination)
{
    ...
    /* create and initialize the stack for unvisited vertices */
    ...
    /* start DFS loop and continue until stack is empty or destination is found*/
    while (!isEmptyCirListDeque(stack) && !found) {
        /* grab vertex off top of stack */
        current = backCirListDeque(stack);
...
int BFS(Graph* g, Vertex* source, Vertex* destination)
{
    ...
    /* create and initialize the queue for unvisited vertices */
    ...
    /* start DFS loop and continue until queue is empty or destination is found*/
    while (!isEmptyCirListDeque(queue) && !found) {
        /* grab vertex off front of queue */
